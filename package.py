...
variants = [
  ...
  ['platform-linux', 'arch-x86_64', 'tbb-2020.3', 'boost-1.82', '!tbb_katana','!boost_katana', 'python-3.11'], # maya 2025
  ...
  ['platform-linux', 'arch-x86_64', 'tbb-2020.3', 'boost-1.80', '!maya', '!tbb_katana','!boost_katana'] #usd 23.08 standalone
]
