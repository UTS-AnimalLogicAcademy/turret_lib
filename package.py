...
variants = [
  ...
  ['platform-linux', 'arch-x86_64', 'tbb-2020.3', 'boost-1.76', '!katana'], # maya 2023/Nuke 14.1
  ...
  ['platform-linux', 'arch-x86_64', 'tbb-2020.3', 'boost-1.72.0', '!python-3', '!katana', '!nuke'], # houdini 19
  ...
  ['platform-linux', 'arch-x86_64', 'tbb_katana-2019.6', 'boost_katana-1.70', 'katana-4.5.2', '!maya', '!nuke'], # katana 4.5v2
